...
* All-in-one contact page that can **inherit** the look and feel of your theme
* Includes your business name, address, phone number(s), email(s) and business hours
* Downloadable **vCard** allowing visitors to easily add your business to their contacts
* **Social Media** Links to make it easy to find you on Twitter, Facebook and more
* Automatically generated **Google map** of your location with **directions**
* **Photo carousel** lets you show images of your building, location, parking, etc. 
* Integrated **click to call** lets visitors instantly call your business from their computer
* **Contact request form** to request an **email response** or a **call back** 
* No programming required simply adds as a **contact page** or use the **shortcode** or **widget** on existing pages
* **Mobile** device optimized
* **MightyCall Centralized Activity Queue** that collects multi-channel contact requests
* Managed through a free account on MightyCall.com

**Multi-channel Communications**

Make it easy for your website visitors to contact your business.  MightyCall Contact Page brings together a selection of the most popular communication channels including email, website contact form, social media and voice calls.  

**The MightyCall Visual Page Editor**

Easily configure your MightyCall Contact Page using the free MightyCall.com visual editor where you can turn on/off features and enter your business specific information.  Changes made in the visual editor are immediately available wherever your contact page is displayed including your Wordpress website. 

**MightyCall Activity Queue**

Organize customer requests for your business into a multi-user management queue on MightyCall.com.  Add notes, assign follow-up to others and make sure that every request is follow through.  The MightyCall Activity Queue can currently acquire & help you manage activities from: 

* The MightyCall Contact Page
* Messages forwarded to todo@mightycall.com from any email registered with your account - great for shared inboxes like sales@company.com
* User added to-do items
* MightyCall Voicemails (requires a MightyCall paid phone number subscription) 
* Twitter Mentions and Direct Messages
* Additional connectors are planned to be added to support contact requests from social media and 3rd party applications

For more information visit the Plug-in page for the MightyCall Contact Page or email us at info@infratel.com. 
...
1. To get your MightyCall ID signup for a free MightyCall account at https://panel.mightycall.com/reactstore.
